...
public class tablePage {
    ...
    public boolean isLevelFiltered(String level) {
        ...
        List<WebElement> levelCells = driver.findElements(By.xpath("//td[@headers='col_level']")); // Assuming level is in the fourth column
        for (WebElement cell : levelCells) {
            if (!cell.getText().equalsIgnoreCase(level)) {
                return false;
            }
        }
        return true; // Placeholder return value
